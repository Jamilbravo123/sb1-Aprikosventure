...
export default function TeamHeader() {
  return (
    <div className="mx-auto max-w-3xl text-center">
      ...
      Aprikos Venture stands at the forefront of entrepreneurship and innovation as a dynamic Norwegian shareholder company founded in 2020. As a venture studio, we empower progress by cultivating groundbreaking ideas and transformative technologies. Meet the dedicated team driving innovation and fostering growth at Aprikos Venture.  
      </p>
    </div>
  );
}